...
from PySide6.QtGui import QSyntaxHighlighter, QTextCharFormat, QTextDocument, QTextCursor
from PySide6.QtWidgets import QCheckBox, QGroupBox, QHBoxLayout, QLabel, QLineEdit, QPlainTextEdit, QVBoxLayout, QWidget
...
class EventsViewer(QGroupBox):
	...
	filters_changed = Signal()  # emitted when any Events Viewer visibility filter changes
